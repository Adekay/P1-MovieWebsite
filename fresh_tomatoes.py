...
<div class="col-md-4 col-lg-4 movie-base text-center">
    <div class="movie-tile" data-trailer-youtube-id="{trailer_id}" data-toggle="modal" data-target="#trailer">
      <h2>{movie_title}</h2>
      <img src="{poster_url}" width="220" height="342" title="{movie_description}">
    </div>
    <div class="movie-details">
      <p align="left">
        ...
        {related_links}</br>
        <img src="imdb.png" alt=""><a href="{imdb_url}" target="_blank">IMDB</a>&nbsp;&nbsp;&nbsp;<img src="rotten_tomatoes.jpeg" alt=""><a href="{rt_url}" target="_blank">Rotten Tomatoes</a>
      </p>
    </div>
</div>
'''
...
def create_movie_tiles_content(movies):
    ...
    for movie in movies:
        ...
        content += movie_tile_content.format(
            ...
            related_links=movie.get_related_content_links(),
